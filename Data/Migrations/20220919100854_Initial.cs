    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshToken<User>", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RefreshToken<User>_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshToken<User>_UserId",
                table: "RefreshToken<User>",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RefreshToken<User>_Value",
                table: "RefreshToken<User>",
                column: "Value");
        }
